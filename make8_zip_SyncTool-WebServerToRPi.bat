...
REM ============================================================
REM make8_zip_SyncTool-WebServerToRPi.bat
REM Put this BAT in: ...\sidscri-apps\
REM Creates ZIP in the SAME folder as this BAT:
REM   SyncTool-WebServerToRPi-v<major.minor.patch> v<build>.zip
REM ZIP contents root:
REM   tools\SyncTool-WebServerToRPi\...
REM Reads:
REM   .\tools\SyncTool-WebServerToRPi\version.json
REM Excludes (recursively, guaranteed):
REM   .venv, __pycache__, *.pyc
REM Writes log:
REM   logs\SyncTool-WebServerToRPi.log
REM ============================================================
...
set "PROJ=SyncTool-WebServerToRPi"
