...
## 8.7.0 (build 60) — 2026-02-05

### Added
- AI generator **Instructions** box that overrides “Short answers only” when provided.
- Deck AI setting (default OFF): show compact formatting helper buttons/dropdown for Term/Definition templates.
...
- AI Generator instructions box no longer stays populated after leaving the AI Generator; added a Clear button next to “Insert example format”.
