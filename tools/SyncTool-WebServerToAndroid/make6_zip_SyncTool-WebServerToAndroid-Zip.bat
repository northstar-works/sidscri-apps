...
REM ============================================================
REM make6_zip_SyncTool-WebServerToAndroid-Zip.bat
REM Put this BAT in: ...\sidscri-apps\tools\SyncTool-WebServerToAndroid\
REM Creates ZIP in the SAME folder as this BAT:
REM   SyncTool-WebServerToAndroid-v<major.minor.patch> v<build>.zip
REM ZIP contents root:
REM   %~dp0
REM Reads:
REM   %~dp0\version.json
REM Excludes (recursively, guaranteed):
REM   .venv, __pycache__, *.pyc
REM Writes log:
REM   logs\SyncTool-WebServerToAndroid.log
REM ============================================================
...
set "PROJ=SyncTool-WebServerToAndroid"
set "SRC=%BASE%"
set "SRC=%TOOLS_DIR%\%PROJ%"
set "VERJSON=%SRC%\version.json"

set "LOGDIR=%SRC%\logs"\%PROJ%.log"
